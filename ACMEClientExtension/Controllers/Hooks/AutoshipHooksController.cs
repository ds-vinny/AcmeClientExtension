...
namespace ACMEClientExtension.Controllers.Hooks
{
    ...
    public class AutoshipHooksController : ControllerBase
    {
        ...
        public async Task<ActionResult<CreateAutoshipHookResponse>> CreateAutoshipHook([FromBody] CreateAutoshipHookRequest request)
        {
            ...
            // Execute the DirectScale callback method with the modified 'request' object that was passed into the controller as well as the one-time callbackToken
        ...
        public async Task<ActionResult<GetAutoshipsHookResponse>> GetAutoshipsHook([FromBody] GetAutoshipsHookRequest request)
        {
